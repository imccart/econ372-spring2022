...
<p><a class="btn btn-primary btn-lg" target="_blank" href="https://imccart.github.io/Econ372-content/syllabus-spring2022/syllabus.pdf" role="button"><i class="far fa-file-pdf"></i> Download PDF of Syllabus</a></p>
...
### Accessing data
For all assignments and in-class activities, I will house all of the links to the data on our class website. For transparency, I will also point you to other GitHub repositories where available. If you're new to Git or GitHub and want to understand some of that better, take a look at [Grant McDermott's](https://grantmcdermott.com/) notes on [Data Science for Economists](https://github.com/uo-ec607/lectures) as well as [Jenny Bryan's](https://jennybryan.org/) online reference book, [Happy Git and GitHub with R](https://happygitwithr.com/). But again, knowledge of Git or GitHub is not expected or required for this class.


### Turning things in
All assignments should be submitted as PDF files on Canvas. Since we'll be using some math in all of our answers, I suggest that all assignments be completed through [Overleaf](https://www.overleaf.com/). As an Emory student, everyone has access to an institutional Overleaf account, which provides you with all the nice features of the product. You can use this to easily write PDF documents in a language known as "LaTeX". For a brief introductory video and links to more info, please see the video [here](https://www.overleaf.com/learn/latex/Questions/Getting_started_with_LaTeX_and_Overleaf_(formerly_writeLaTeX)).
...
All regular class meetings will take place in **White Hall, Room 102** on Mondays and Wednesdays from 8:30am to 9:45am. 


### Office hours

My designated office hours will be on Monday and Wednesday from 2:30 to 3:30pm in PAIS 573. I'm also available outside of these times. I just ask that you schedule an appointment in advance. [Make an appointment with me here.](https://mccarthy-meetings.youcanbook.me/)
