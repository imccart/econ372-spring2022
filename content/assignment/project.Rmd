...
Select five DRG codes that you'd like to study in more detail, and provide a table of summary values for each hospital. For example, your table could show the mean charge and payments for these procedures by hospital, as well as the count of hospitals that are compliant.

6. Summarize data for specific procedures:

For those same DRG codes, calculate the range of charges, negotiated prices, and Medicare payments *across hospitals* in your market. Show these ranges in a figure.
